...
//should probably calculate if enough balance in users account to buy first...
    ...
    $total=0;
	$stmt = $conn->prepare("SELECT tbltuck.Name as tn, tbltuck.Cost as tp, tblbasket.Quantity as qty FROM tblbasket INNER JOIN tbltuck on tbltuck.TuckID = tblbasket.TuckID where tblbasket.OrderID=:orderid");
